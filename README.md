...
**«Прозрачность» по-узбекский. Каждый подозрительный тендер — у вас на виду через 5 минут после публикации.**
...
- 📑 Десятки тысяч тендеров публикуются ежегодно — **ноль публичных real-time инструментов** анализа
- 📰 Журналисты-расследователи проверяют тендеры **вручную** — это занимает дни
- 🇺🇿 Прямое продолжение курса Президента на открытость и цифровизацию госуправления
- 🌍 Открытые данные (Open Government Data) — **глобальный тренд 2026** (приоритет UNDP, World Bank)

### Технологическая зрелость и инновация

| Инновация | Реализация |
|---|---|
| **Multi-LLM конвейер** | OpenAI GPT-4o-mini + Anthropic Claude 4.5 + Perplexity sonar-pro с автоматическим fallback |
| **3-уровневая прогрессивная AI-аналитика** | L1 быстро → L2 глубокий research → L3 журналистский отчёт |
| **Streaming AI** | Модель пишет ответ в реальном времени (SSE из OpenAI) |
...
| **Public REST API + CORS** | Открытый интерфейс для прессы и НКО |
...
| **22 routes · 15 API · 100% deployed** | Не макеты — **работающий продукт в продакшене** |

### Готовность к демонстрации

- 📖 **Этот README** — структурированное изложение проблемы, решения и архитектуры
- 🎬 **Live demo** на Railway — продукт доступен 24/7
- 🎮 **DEMO-режим** — стабильный показ функций без зависимости от внешних API
- 🗺 **Mermaid-диаграммы** прямо в README — визуальное представление потоков данных
- 📊 **Dashboard** с KPI — метрики проекта на одном экране
- 💻 **Open-source на GitHub** — прозрачность кода соответствует идеологии самого проекта
- 🤖 **AI-чат внутри продукта** — задавайте любой вопрос, ассистент ответит на основе данных из БД
...
## 👥 Команда [WHOMEVER](https://whomever.uz)

> 🌐 [**whomever.uz**](https://whomever.uz) — официальный сайт компании
...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <br/><br/>
      <code>CEO @ <a href="https://whomever.uz">WHOMEVER</a></code><br/>
...
### 💚 Сделано командой [WHOMEVER](https://whomever.uz)
...
[Live Demo](https://shaffof-antikor-mvp-production.up.railway.app) · [GitHub](https://github.com/Wh0mever/SHAFFOF-ANTIKOR-MVP) · [whomever.uz](https://whomever.uz)
...
### 🏢 [**OOO WHOMEVER**](https://whomever.uz)

🌐 **[whomever.uz](https://whomever.uz)** · 📧 [contact@whomever.uz](mailto:contact@whomever.uz)

*© 2026 OOO WHOMEVER. Все права защищены.*
